...
Route::middleware('auth')->group(function () {
    ...
    //商品の購入
    Route::get('/search/buy/{id}', [App\Http\Controllers\BuyController::class, 'buy'])->name('buys');//商品の購入処理
...
Route::middleware(['auth', 'isAdmin'])->group(function () {
    ...
    Route::post('/item/destroy/{id}', [App\Http\Controllers\ItemController::class, 'destroy'])->name('destroy'); //商品削除処理 & 購入商品削除処理(利用者用のコメント)
